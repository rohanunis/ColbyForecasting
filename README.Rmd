...
Instructors: Nick Record, Ben Tupper - Bigelow Laboratory for Ocean Science

e-mail: 

 - Nick Record: nrrecord@colby.edu, nrecord@bigelow.org [both arrive at the Bigelow email]
...
Virtual (zoom) office hours by appointment - just contact [Ben Tupper](mailto:btupper@bigelow.org)

Location: Miller 205


## Handy links
  + [Coding Tutorial Pages](https://bigelowlab.github.io/ColbyForecasting/)

  + [Coding Wiki Tips, Tricks and free Advice](https://github.com/BigelowLab/ColbyForecasting/wiki) 
...
### 1. Tuesday Jan 6
 ...
 - R Tutorial: [Coding](https://bigelowlab.github.io/ColbyForecasting/C00_coding.html)
 
 - Reading assignment for next time:
   The Gulf of Maine articles in this [folder](https://github.com/BigelowLab/ColbyForecasting/tree/main/reading/Woodard)

### 2. Thurs Jan 8
 
  - Lecture: Ocean Science / Gulf of Maine Primer
 
  - Discussion: [Forecast cards](https://docs.google.com/spreadsheets/d/1gPwJF2XAKD9WftHAgRY9X_CXpn-S0gQFDZeF7yxdIGo/edit?gid=0#gid=0) and [Table 1 in this paper](https://github.com/BigelowLab/ColbyForecasting/blob/main/reading/RecordEtal2025inreview.pdf)
  
  - R Tutorial: [Observations](https://bigelowlab.github.io/ColbyForecasting/C01_observations.html)
 
  - Reading assignment for next time: [Mollomo 1998](https://github.com/BigelowLab/ColbyForecasting/blob/main/reading/Mollomo1998.pdf)
  ...
  - R Tutorial: [Background Points](https://bigelowlab.github.io/ColbyForecasting/C02_background.html)
  
  - Reading assignment for next time: [Brickman 2020](https://github.com/BigelowLab/ColbyForecasting/blob/main/reading/Brickman.elementa.2020.20.00055.pdf)


### 3. Monday Jan 12
  - Lecture: Forecasting Methodologies
 
  - R Tutorial: [Covariates](https://bigelowlab.github.io/ColbyForecasting/C03_covariates.html)
...
## 4. Tuesday Jan 13
  ...
  - R Tutorial: [Modeling](https://bigelowlab.github.io/ColbyForecasting/C04_models.html)
  
  - Reading assignment for next time: [(a) What is algorithmic bias](https://bdtechtalks.com/2018/03/26/racist-sexist-ai-deep-learning-algorithms/), [(b) Predictive Policing](https://www.science.org/content/article/can-predictive-policing-prevent-crime-it-happens) and [(c) Managing bias in AI](https://lin-web.clarkson.edu/~jmatthew/publications/ManagingBiasInAI_CAMERAREADY.pdf)
...
## 5. Thursday Jan 15 
  ...
  - R Tutorial: [Predicting](https://bigelowlab.github.io/ColbyForecasting/C05_prediction.html)
  
  - Reading assignment for next time: TBD
   
## Monday Jan 23
  
  No class, [Dr. Martin Luther King Day](https://en.wikipedia.org/wiki/Martin_Luther_King_Jr._Day)
 
## 6. Tuesday Jan 20

 - R Tutorial: Spillover and catch-up
 
 - Reading assignment for next time: [(a) Pershing 2020](https://github.com/BigelowLab/ColbyForecasting/blob/main/reading/Pershing.elementa.2020.00076.pdf) and [(b) Hobday 2020](https://github.com/BigelowLab/ColbyForecasting/blob/main/reading/Hobday2020.pdf)
...
## 9. Tuesday Jan 27
 - Final project due
   - A ~2,000 word write-up of your Gulf of Maine projection. [Details can be found here](https://github.com/BigelowLab/ColbyForecasting/blob/main/assignments/writeup.md).
...
There is no textbook for this course. Readings will be provided (including primarly literature searches by the students). The tutorial for the coding portion is provided [here](https://bigelowlab.github.io/ColbyForecasting/).
...
Other resources of interest:
 ...
 - [Tidy Species Distribution Modeling](https://evolecolgroup.github.io/tidysdm/)
